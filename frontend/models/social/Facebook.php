...
class Facebook extends AbstractAdapter
{
    ...
    public function authenticate()
    {
        ...
        if (isset($_GET['code'])) {
            ...
            parse_str($this->get('https://graph.facebook.com/oauth/access_token', '?fields=email,name&', $params, false), $tokenInfo);
            if (count($tokenInfo) > 0 && isset($tokenInfo['access_token'])) {
                $params = array('access_token' => $tokenInfo['access_token']);
                $userInfo = $this->get('https://graph.facebook.com/me', '?fields=email,name&' ,$params);
